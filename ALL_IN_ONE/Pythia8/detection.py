from one_key_run import detect_folder_files, detect_folder_files_r, combine_files_precise, combine_files_precise_r
import os
...
def detect_r_and_combine(LLP_folder_path):
    ...
    final_files_r = combine_files_precise_r(completed_r_folder_path)
...
def detect_percise_and_combine(LLP_folder_path):
    ...
    final_files = combine_files_precise(completed_folder_path)
    print('The Final Step is Over, See the .csv files for LLPs Completed Data')
